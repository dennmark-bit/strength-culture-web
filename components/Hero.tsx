  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-darkbg overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <p className="text-zinc-400 text-xs uppercase tracking-[0.4em] mb-6">Central, Hong Kong</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="#classes"
            className="border border-white/30 text-white px-8 py-4 font-bold uppercase tracking-widest text-sm hover:border-white hover:text-white transition"
          >
            See Classes
          </Link>
        </div>
