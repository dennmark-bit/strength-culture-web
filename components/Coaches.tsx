  ...
  return (
    <section id="coaches" className="bg-darkbg py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <p className="text-zinc-400 text-xs uppercase tracking-[0.4em] mb-4 text-center">The Team</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {coaches.map((c, i) => (
            <div key={i} className="bg-darkcard border border-white/5 hover:border-white/20 transition p-8">
              ...
              <p className="text-zinc-400 text-xs uppercase tracking-wider mb-4">{c.role}</p>
