  ...
  return (
    <section className="bg-zinc-950 py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <p className="text-xs uppercase tracking-[0.4em] mb-4 text-center" style={maroonGradient}>Community</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-darkcard border border-white/5 p-8">
              <p className="text-3xl font-black mb-4" style={maroonGradient}>"</p>
