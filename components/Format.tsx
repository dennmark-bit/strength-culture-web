  ...
  return (
    <section id="classes" className="bg-darkbg py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <p className="text-gold text-xs uppercase tracking-[0.4em] mb-4 text-center">What We Offer</p>
        <h2 className="text-4xl md:text-5xl font-black uppercase text-center mb-16">
          Train Your Way
        </h2>
        <div className="grid md:grid-cols-2 gap-2">
          {/* Group Classes */}
          <div className="bg-darkcard p-10 border border-white/5 hover:border-gold/40 transition group">
            <p className="text-gold text-xs uppercase tracking-widest mb-4">01. Community</p>
            ...
            <p className="text-xs text-zinc-500 uppercase tracking-wider border-l-2 border-gold pl-4">
              PRO TIP: Not sure where to start? Book a free consultation and our coaches will recommend the right class for your level.
            </p>
          </div>
          {/* Personal Training */}
          <div className="bg-darkcard p-10 border border-white/5 hover:border-gold/40 transition group">
            <p className="text-gold text-xs uppercase tracking-widest mb-4">02. 1-on-1</p>
